                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <i class="fa fa-user"></i> Pesquisa de Usuario</div>
                            <div class="card-body">
                                ...
                                <form>
                                    <div class="form-group">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                <label for="data">Nome ou ID:</label>
                                                <input class="form-control" id="" type="date" placeholder="Digite o Nome ou ID">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <a href="listarUsuario.php"> <button type="button" class="btn btn-primary"> <i class="fa fa-search"></i>  Pesquisar</button> </a>
                                    </div>
                                </form>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <span> Pesquisar por tipo de usuario e em seguida pesqusiar por "ID" ou pelo "Nome" </span>
