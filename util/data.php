...
/*
 * ajusta a hora para o fusio horário
 */
...
function convertDate($date) {
    if (preg_match("/^[0-9]{4}(\/|-|.)(0[1-9]|1[0-2])(\/|-|.)(0[1-9]|[1-2][0-9]|3[0-1])$/", $date)) {
        $data = substr($date, 8, 2) . substr($date, 7, 1) . substr($date, 5, 2) . substr($date, 4, 1) . substr($date, 0, 4);
        // Result: '25/11/1989' - OR - '25-11-1989' - OR - '25.11.1989'
        $dados = explode('-', $data);
        $data_convert = "{$dados['0']}/{$dados['1']}/{$dados['2']}";
        return $data_convert;
    }
